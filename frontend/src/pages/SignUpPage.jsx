...
const SignUpPage = () => {
    ...
    return (
        <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
            ...
            >
                <h2 className='mt-6 text-center text-3xl font-extrabold text-stone-400'>Create your account</h2>
            </motion.div>
            ...
            >
                <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                            ...
                            <div className='mt-1 relative rounded-md shadow-sm'>
                                ...
                                <input
                                    ...
                                    className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm
									 placeholder-gray-400 focus:outline-none focus:ring-stone-400 focus:border-stone-400 sm:text-sm'
                            ...
                            <div className='mt-1 relative rounded-md shadow-sm'>
                                ...
                                <input
                                    ...
                                    className=' block w-full px-3 py-2 pl-10 bg-gray-700 border
									 border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-stone-400 focus:border-stone-400 sm:text-sm'
                                    placeholder='••••••••'
                                />
                            </div>
                        </div>
                    ...
                    <p className='mt-8 text-center text-sm text-gray-400'>
                        ...
                        <Link to='/login' className='font-medium text-stone-400 hover:text-stone-300'>
